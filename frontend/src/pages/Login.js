    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="bg-surface border-2 border-primary p-8 shadow-[8px_8px_0_0_#111111]">
          ...
          <p className="text-text-muted font-body text-sm mb-8">Sign in to your account</p>
          
          {error && (
            <div data-testid="login-error" className="bg-accent/10 border-2 border-accent text-accent px-4 py-3 mb-6 font-body text-sm">
              {error}
            </div>
          )}
          ...
          <p className="mt-6 text-center font-body text-sm text-text-muted">
            ...
            <Link to="/register" data-testid="register-link" className="text-primary font-bold hover:text-accent transition-colors">
              Register
            </Link>
          </p>
        </div>
